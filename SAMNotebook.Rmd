...
last_plot()  
```
The above model has the best DIC of all, is ranked in the 74th percentile or higher
...
last_plot()  
```
The above is the best performing model with no metric lower than the 81st percentile
